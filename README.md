...
| ✂️ 2단계 손절 | 1차 SL 도달 시 50%만 매도·나머지 반등 대기, 2차 SL 도달 시 잔량 전체 청산. 실효 손실 ≈ -2.25% |
| 🎣 트레일링 익절 | 익절 돌파 시 고점 추적 → 고점 대비 하락 시 매도 (오프셋 0.3~1.0% 동적 조정) |
| ⚡ 전략 최적화 | StrategyOptimizer — 매매 즉시 파라미터 재결정. 익절 2~6%, 2차 손절 -1.5~-4.5% 범위 |
